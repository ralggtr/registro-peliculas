...
<div>
  ...
  <div class="mt-1 relative rounded-md shadow-sm py-5">
    ...
    <input wire:model="findnumber" type="text" name="findnumber" id="findnumber" class="focus:ring-indigo-500 focus:border-indigo-500 block w-half pl-7 pr-12 sm:text-sm border-gray-300 rounded-md" placeholder="[1]">
  </div>
</div>
