...
<div>
  <label for="numbers" class="block text-sm font-medium text-gray-700">Ingrese un numero:</label>
  <div class="mt-1 relative rounded-md shadow-sm py-5">
    ...
    <input wire:model="numbers" type="text" name="numbers" id="numbers" class="focus:ring-indigo-500 focus:border-indigo-500 block w-half pl-7 pr-12 sm:text-sm border-gray-300 rounded-md" placeholder="">
  </div>
</div>
...
<div class="my-1.5">
                        <span class="inline-flex rounded-md shado-sm">
                            <button type="submit"
                                ...
                                <span>Verificar si es Número Válido</span>
                            </button>
                        </span>
          </div> 
